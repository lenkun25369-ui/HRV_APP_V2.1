...
for i in new_bin0: 
    try:
        ...
        # hrvpart0= hrvtransform2_only_normal_ECG(hrdata1,new_test,fs,hrv1,settings_time,settings_welch,settings_ar,settings_lomb,settings_nonlinear,max_lag=50)
        # hrvpart0= hrvtransform1(hrdata1,fs,hrv1,settings_time,settings_welch,settings_ar,settings_lomb,settings_nonlinear,max_lag=50)
